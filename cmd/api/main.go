...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "ff000c31a6a652", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "ec70d281de0e41", "SMTP password")
